...
# [SYSTEM CONFIG]
st.set_page_config(
    page_title="Dream-Fi Vault v29.0", 
    page_icon="🏛️", 
    layout="wide", 
...
LANG = {
    "KO": {
        ...
        # ▼▼▼ [복구 완료] 비즈니스 인큐베이팅 및 바이백 내용 원상 복구 ▼▼▼
...
st.markdown("""
    ...
    /* 2. [흰색 막대 제거] Expander 헤더 강제 설정 (핵심 수정) */
    .streamlit-expanderHeader {
        background-color: #111111 !important; /* 배경을 무조건 검게 */
        color: #D4AF37 !important; /* 글씨는 무조건 금색 */
        border: 1px solid #333 !important;
        border-radius: 5px !important;
    }
    .streamlit-expanderHeader:hover {
        color: #FDB931 !important; /* 마우스 올리면 밝은 금색 */
